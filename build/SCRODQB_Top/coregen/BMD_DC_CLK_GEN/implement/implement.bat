...
xst -ifn xst.scr
move BMD_DC_CLK_GEN_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\BMD_DC_CLK_GEN_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc BMD_DC_CLK_GEN_exdes.ucf BMD_DC_CLK_GEN_exdes

echo 'Running map'
map -timing -pr b BMD_DC_CLK_GEN_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm BMD_DC_CLK_GEN_exdes -w routed.ncd routed.v
cd ..
