...
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax BMD_DC_CLK_GEN_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.BMD_DC_CLK_GEN_tb work.glbl
