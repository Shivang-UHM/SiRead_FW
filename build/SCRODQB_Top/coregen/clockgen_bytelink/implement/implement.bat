...
xst -ifn xst.scr
move clockgen_bytelink_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockgen_bytelink_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockgen_bytelink_exdes.ucf clockgen_bytelink_exdes

echo 'Running map'
map -timing -pr b clockgen_bytelink_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockgen_bytelink_exdes -w routed.ncd routed.v
cd ..
